...
def calculate_stocks(df_stocks, account_balance, max_stocks):
    ...
    # calculating the strength of the stock - hypothetical
    df_stocks['Volume Strength'] = round(df_stocks['Volume'] / df_stocks['Avg Vol (3m)'], 2)
...
if __name__ == '__main__':
    ...
    stocks_to_buy = calculate_stocks(df, account_balance=100000.0, max_stocks=25)

    # adjust page load timeout and trading timeout according to your internet connection, vpn, ping
    e_toro_bot = EToroBot(
        account_name='vpr2108',
        account_email='vpr2108@columbia.edu',
        account_password='Vrj1184344240!',
        page_load_timeout=5,
        trading_timeout=2
    )
